...
const Navs = () => {
  ...
  return (
    <div className="fixed w-full h-[70px] justify-between items-center bg-blue-300">
      <div className="px-5 flex items-center py-3 rounded-md text-whitefont-bold w-full ">
        ...
        `}
          onClick={() => {
            ...
            getYoutubeVideos("Technology").then((res) => {
              console.log(res);
              localStorage.setItem(
                "youtube",
                JSON.stringify(res[2].Technology)
              );
            });
          }}
        >
        ...
        `}
          onClick={() => {
            ...
            getYoutubeVideos("Movies").then((res) => {
              console.log(res);
              localStorage.setItem("youtube", JSON.stringify(res[2].Movies));
            });
          }}
        >
          Movies
